                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title" id="basic-layout-card-center">Add User</h4>
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    ...
                                    <form class="form" action="{{route('create-user')}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="userinput2" class="form-control border-primary" placeholder="username" name="username">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" id="userinput4" class="form-control border-primary" placeholder="upload image" name="profilei">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="form-actions text-right">
                                            <a href="{{route('users')}}"><button type="button" class="btn btn-warning mr-1">
